...
import { TrendingUp, Users, Target, Plane } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-card">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          Join a savings circle with friends and family to reach your dream vacation faster. Transparent, secure, and
          fun.
        </p>
        <div className="flex gap-4 justify-center flex-wrap">
          ...
          <Button
            ...
            className="px-8 py-6 text-lg rounded-full border-primary text-primary hover:bg-primary/5 bg-transparent"
          >
            Learn More
          </Button>
        </div>
